...
function ContactUs() {
    ...
    return (
        <section id="contact" className="relative bg-gradient-to-b from-green-50 via-white to-green-50 py-28 px-4 overflow-hidden">
            ...
            <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12">
                ...
                <div className="flex flex-col gap-8" data-aos="fade-left">
                    {[
                        ...
                        { icon: <FiMapPin className="w-6 h-6 text-green-500" />, title: "Office", desc: "Karnataka: Bhavan Complex, Attibelle, Bengaluru \nTamil Nadu: Sunnambu Zeebee, Hosur" },
                    ].map((item, idx) => (
