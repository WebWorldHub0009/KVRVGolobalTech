...
const FloatingButtons = () => {
    ...
    return (
        <div className="fixed bottom-6 right-6 z-50 flex flex-col items-center gap-4">
            ...
            <AnimatePresence>
                ...
                hover:scale-110 hover:rotate-6"
                        ...
                        <motion.a
                            ...
                            className="w-14 h-14 flex items-center justify-center rounded-full
                bg-gradient-to-br from-green-400 via-teal-500 to-emerald-600 text-white
                shadow-2xl ring-2 ring-white/20 transition-transform duration-300
                hover:scale-110 hover:-rotate-6"
                        >
                            <FaWhatsapp size={26} />
            ...
            {/* ✉️ Main Toggle Button (Glowing KVRV theme) */}
            <div className="relative">
                {/* Animated Glow Rings */}
                <span className="absolute inset-0 rounded-full bg-green-400/40 animate-ping-slow"></span>
                <span className="absolute inset-0 rounded-full bg-teal-300/30 animate-ping-slower"></span>
            ...
            bg-gradient-to-br from-green-500 via-teal-500 to-green-700
